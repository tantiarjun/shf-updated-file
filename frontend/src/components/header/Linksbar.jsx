  ...
  return (
    <div className="flex justify-center items-center py-1 bg-linksBar px-8 md:justify-between">
      <div className="flex space-x-5 md:space-x-4">
        ...
        {/* <Link to="/donate" className="text-white text-xl md:hidden">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div className="email justify-center items-center hidden md:block">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-gray-400 text-xl hover:text-white transition duration-300 inline-flex gap-2 justify-center items-center"
        >

          <img src="/Images/email.png" style={{ width: "20px", marginTop: "5px" }} />
